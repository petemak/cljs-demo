...
return html_coll.item(p1__16182_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__16183_SHARP_);
...
var ctx_16184 = cvs.getContext("2d");
ctx_16184.fillStyle = color;

ctx_16184.fillRect((0),(0),size,size);
