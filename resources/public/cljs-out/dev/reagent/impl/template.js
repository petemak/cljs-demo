...
var G__16512 = o;
(G__16512[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__16514__i < G__16514__a.length) {G__16514__a[G__16514__i] = arguments[G__16514__i + 0]; ++G__16514__i;}
  args = new cljs.core.IndexedSeq(G__16514__a,0,null);
} 
...
var G__16516 = o;
(G__16516[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__16518__i < G__16518__a.length) {G__16518__a[G__16518__i] = arguments[G__16518__i + 0]; ++G__16518__i;}
  args = new cljs.core.IndexedSeq(G__16518__a,0,null);
} 
...
var G__16521 = props;
var G__16521__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__16521,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__16521);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__16521__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__16522){
var map__16523 = p__16522;
var map__16523__$1 = (((((!((map__16523 == null))))?(((((map__16523.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16523.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16523):map__16523);
var props = map__16523__$1;
var class$ = cljs.core.get.call(null,map__16523__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__16523,map__16523__$1,props,class$){
return (function (c){
...
});})(map__16523,map__16523__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__16525){
var map__16526 = p__16525;
var map__16526__$1 = (((((!((map__16526 == null))))?(((((map__16526.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16526.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16526):map__16526);
var on_write = cljs.core.get.call(null,map__16526__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__16526,map__16526__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__16526,map__16526__$1,on_write))
);
} else {
...
var G__16529 = jsprops;
(G__16529["defaultValue"] = value);

(G__16529["onChange"] = ((function (G__16529,v,value,on_change){
return (function (p1__16528_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__16528_SHARP_);
});})(G__16529,v,value,on_change))
);
...
var vec__16532 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__16532,(0),null);
var id = cljs.core.nth.call(null,vec__16532,(1),null);
var class$ = cljs.core.nth.call(null,vec__16532,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___16536 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___16536 == null)){
} else {
var key_16537 = temp__5461__auto___16536;
(jsprops["key"] = key_16537);
}
...
var temp__5461__auto___16538 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___16538 == null)){
} else {
var key_16539 = temp__5461__auto___16538;
reagent.impl.template.oset.call(null,jsprops,"key",key_16539);
}
...
var G__16540 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__16540["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq16544){
...
break;
default:
var G__16551 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__16551;
continue;
...
var n__4607__auto___16553 = a.length;
var i_16554 = (0);
while(true){
if((i_16554 < n__4607__auto___16553)){
(a[i_16554] = reagent.impl.template.as_element.call(null,(a[i_16554])));

var G__16555 = (i_16554 + (1));
i_16554 = G__16555;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___16556 = a.length;
var i_16557 = (0);
while(true){
if((i_16557 < n__4607__auto___16556)){
var val_16558 = (a[i_16557]);
if(((cljs.core.vector_QMARK_.call(null,val_16558)) && ((reagent.impl.template.key_from_vec.call(null,val_16558) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_16557] = reagent.impl.template.as_element.call(null,val_16558));
...
var ctx = ({});
var vec__16560 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__16560,(0),null);
var derefed = cljs.core.nth.call(null,vec__16560,(1),null);
...
var G__16563 = (cljs.core.count.call(null,argv) - first_child);
switch (G__16563) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__16563){
