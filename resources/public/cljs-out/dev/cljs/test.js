...
var G__15911 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__15911,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__15911;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq15913){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15914,G__15915,seq15913__$2);
});
...
var map__15920 = m;
var map__15920__$1 = (((((!((map__15920 == null))))?(((((map__15920.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15920.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15920):map__15920);
var file = cljs.core.get.call(null,map__15920__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15920__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15920__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__15920,map__15920__$1,file,line,column){
return (function (p1__15919_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__15919_SHARP_));
});})(map__15920,map__15920__$1,file,line,column))
...
var temp__5457__auto___15922 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___15922)){
var message_15923 = temp__5457__auto___15922;
cljs.core.println.call(null,message_15923);
} else {
}
...
var temp__5457__auto___15924 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___15924)){
var message_15925 = temp__5457__auto___15924;
cljs.core.println.call(null,message_15925);
} else {
}
...
var output_dir__$1 = (function (){var G__15926 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__15926,"/"].join('');
} else {
return G__15926;
}
})();
...
var G__15928 = exception.stack;
var G__15928__$1 = (((G__15928 == null))?null:clojure.string.split_lines.call(null,G__15928));
var G__15928__$2 = (((G__15928__$1 == null))?null:cljs.core.get.call(null,G__15928__$1,depth));
if((G__15928__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__15928__$2);
}
} else {
...
var vec__15929 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__15929,(0),null);
var column = cljs.core.nth.call(null,vec__15929,(1),null);
var vec__15932 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__15932,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__15932,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__15932,(2),null);
...
var m__$1 = (function (){var G__15935 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__15935__$1 = (((G__15935 instanceof cljs.core.Keyword))?G__15935.fqn:null);
switch (G__15935__$1) {
case "fail":
...
var G__15939 = (function (){var G__15938 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__15938);
} else {
return G__15938;
}
})();
...
return cljs.core.vary_meta.call(null,G__15940,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__15944 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__15944,(0),null);
var types = vec__15944;
...
return cljs.core.map.call(null,(function (p__15947){
var vec__15948 = p__15947;
var ns = cljs.core.nth.call(null,vec__15948,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__15948,(1),null);
return ((function (vec__15948,ns,vars__$1){
return (function (){
...
var G__15951 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__15951,G__15951__$1,env,once_fixtures,each_fixtures,vec__15948,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__15951,G__15951__$1,env,once_fixtures,each_fixtures,vec__15948,ns,vars__$1){
return (function (){
var seq__15952 = cljs.core.seq.call(null,vars__$1);
var chunk__15953 = null;
var count__15954 = (0);
var i__15955 = (0);
while(true){
if((i__15955 < count__15954)){
var v = cljs.core._nth.call(null,chunk__15953,i__15955);
var temp__5457__auto___15957 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___15957)){
var t_15958 = temp__5457__auto___15957;
each_fixture_fn.call(null,((function (seq__15952,chunk__15953,count__15954,i__15955,t_15958,temp__5457__auto___15957,v,each_fixture_fn,G__15951,G__15951__$1,env,once_fixtures,each_fixtures,vec__15948,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_15958)));
});})(seq__15952,chunk__15953,count__15954,i__15955,t_15958,temp__5457__auto___15957,v,each_fixture_fn,G__15951,G__15951__$1,env,once_fixtures,each_fixtures,vec__15948,ns,vars__$1))
);
} else {
}


var G__15959 = seq__15952;
var G__15960 = chunk__15953;
var G__15961 = count__15954;
var G__15962 = (i__15955 + (1));
seq__15952 = G__15959;
chunk__15953 = G__15960;
count__15954 = G__15961;
i__15955 = G__15962;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__15952);
if(temp__5457__auto__){
var seq__15952__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__15952__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__15952__$1);
var G__15963 = cljs.core.chunk_rest.call(null,seq__15952__$1);
var G__15964 = c__4550__auto__;
var G__15965 = cljs.core.count.call(null,c__4550__auto__);
var G__15966 = (0);
seq__15952 = G__15963;
chunk__15953 = G__15964;
count__15954 = G__15965;
i__15955 = G__15966;
continue;
} else {
var v = cljs.core.first.call(null,seq__15952__$1);
var temp__5457__auto___15967__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___15967__$1)){
var t_15968 = temp__5457__auto___15967__$1;
each_fixture_fn.call(null,((function (seq__15952,chunk__15953,count__15954,i__15955,t_15968,temp__5457__auto___15967__$1,v,seq__15952__$1,temp__5457__auto__,each_fixture_fn,G__15951,G__15951__$1,env,once_fixtures,each_fixtures,vec__15948,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_15968)));
});})(seq__15952,chunk__15953,count__15954,i__15955,t_15968,temp__5457__auto___15967__$1,v,seq__15952__$1,temp__5457__auto__,each_fixture_fn,G__15951,G__15951__$1,env,once_fixtures,each_fixtures,vec__15948,ns,vars__$1))
);
} else {
}


var G__15969 = cljs.core.next.call(null,seq__15952__$1);
var G__15970 = null;
var G__15971 = (0);
var G__15972 = (0);
seq__15952 = G__15969;
chunk__15953 = G__15970;
count__15954 = G__15971;
i__15955 = G__15972;
continue;
}
} else {
...
});})(each_fixture_fn,G__15951,G__15951__$1,env,once_fixtures,each_fixtures,vec__15948,ns,vars__$1))
);
});})(each_fixture_fn,G__15951,G__15951__$1,env,once_fixtures,each_fixtures,vec__15948,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15951__$1)].join('')));

}
})());
});
;})(vec__15948,ns,vars__$1))
