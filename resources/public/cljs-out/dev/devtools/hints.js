...
var file = cljs.core.get.call(null,map__18780__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
}catch (e18779){var _e = e18779;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___18782 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___18782)){
var seen_errors_18783 = temp__5455__auto___18782;
if(cljs.core.truth_(seen_errors_18783.has(self))){
} else {
seen_errors_18783.add(self);

var temp__5457__auto___18784 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___18784)){
var sense_18785 = temp__5457__auto___18784;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_18785)].join('');
} else {
}
}
} else {
