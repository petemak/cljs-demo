...
var G__17700 = devtools.prefs.pref.call(null,v);
v = G__17700;
continue;
} else {
return v;
...
}catch (e17703){var _e__16714__auto__ = e17703;
return false;
}})();
...
}catch (e17707){var _e__16714__auto__ = e17707;
return false;
}})();
...
}catch (e17709){var _e__16714__auto__ = e17709;
return false;
}}
}
});
...
var vec__17711 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__17711,(0),null);
var name = cljs.core.nth.call(null,vec__17711,(1),null);
...
return cljs.core.some.call(null,(function (p1__17714_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__17714_SHARP_);
}),template);
});
